...
export default function Page() {
  ...
  const placeholders = [
    ...
    "Can you share your GitHub profile link?",
    "What are your past experiences in development?",
    "Where can I find your resume?",
    "What programming skills do you have?",
    "Do you have any technical blogs I can read?",
  ];
        ...
        <CardContent className="min-h-[400px] h-full border rounded-lg flex flex-col mt-auto">
          ...
          <div className={cn("w-full")}>
            <div className="relative max-w-xl w-full mx-auto flex items-start flex-col gap-2">
              <form
                className={cn(
                  "w-full relative max-w-xl mx-auto bg-[#303030] rounded-3xl overflow-hidden transition duration-200",
                  input && ""
                )}
              ...
              >
                ...
                <Textarea
                  ...
                  value={input}
                  className={cn(
                    "w-full relative text-sm sm:text-base z-50 border-none text-foreground bg-transparent focus:outline-none focus:ring-0 pl-5 pt-4 sm:pl-10 pr-20 pb-4 min-h-[50px]",
