...
const GridItems: GridItemInterface[] = [
  ...
  },
  {
    ...
    username: "@sayandedotcom",
    buttonTitle: "Follow",
    buttonLink: "https://www.instagram.com/sayandedotcom",
    buttonSecondaryText: "6",
    color: null,
  },
];
...
export const siteConfig = {
  ...
  bio: "Hi 👋! I’m Sayan, an ambitious DevOps & Full-Stack Developer from India. Currently pursuing my Masters in Computer Application, I bring a solid foundation in Software Engineering with hands-on experience. I am captivated by the realm of Cloud Computing and DevOps practices, seeking to revolutionize how we deploy applications in the modern era. My unwavering curiosity and drive push me to explore fresh avenues to redefine technological frontiers.",
